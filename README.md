...
- ***I'm not very good with computers. Can I still use wDIM?*** Yes! wDIM is designed to be used by anyone! The application itself features plenty of descriptive explanations throughout (including warnings for things that could go wrong, and errors for things that do), and I've written out very detailed documentation and guides [here]() to help you learn how it works.
- ***Oh, so the app babies you? Does that mean it's not any good for experienced users?*** No! wDIM is instantly up and running, so you can jump right into using it without being held back by annoying prompts and tutorials. Additionally, many features that the app can walk you through can also be done manually: for example, if you don't want to use the GUI I created to make and edit icon sets, you don't have to—they follow a simple structure that you can easily replicate and edit yourself.
